...
class Product(models.Model):
    ...
    SearchDescription = models.CharField(max_length=200, blank=True, null=True)
    ...
    Durometer = models.CharField(max_length=50, blank=True, null=True)

    DurometerScale = models.CharField(max_length=50, blank=True, null=True)

    DurometerRange = models.CharField(max_length=50, blank=True, null=True)
    ...
    MaterialSubtype = models.CharField(max_length=50, blank=True, null=True)
    ...
    InsideDiameter = models.CharField(max_length=50, blank=True, null=True)

    SizeAS568 = models.CharField(max_length=50, blank=True, null=True)

    SizeJIS = models.CharField(max_length=50, blank=True, null=True)

    SizeMetric = models.CharField(max_length=50, blank=True, null=True)
