            ...
            if response.status_code == 200:
                ...
                for item in items:
                    ...
                    if item['AttributeName']:
                        attribute_key = re.sub(r'[^a-zA-Z]', '', item['AttributeName'].replace(' ', ''))
                ...
                for product_data in product_list:
                    ...
                    product = Product(
                        ...
                        LowTemperature=product_data.get('LowTemperatureC'),

                        HighTemperature=product_data.get('HighTemperatureC'),
                        ...
                        CrossSectionalDiameter=product_data.get('CrossSectionalDiameterCS'),

                        InsideDiameter=product_data.get('Inside DiameterID'),

                        SizeAS568=product_data.get('SizeAS568'),
                        ...
                        picture1=product_data.get('PictureodatamediaEditLink'),
                        picture2=product_data.get('PictureodatamediaReadLink'),
